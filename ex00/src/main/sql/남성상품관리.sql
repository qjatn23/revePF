...
-- 3. 샘플 데이터 추가
    ...
    VALUES((select NVL(max(cate_code1),0)+1 from category), 'All');
    ...
    VALUES(1,(select NVL(max(cate_code2),0)+1 from category), 'All');
 
    -- 상품사이즈
    INSERT INTO goods_size(goods_size_no, size_name, goods_no)
    VALUES (goods_size_seq.nextval, 'S', 1);
    INSERT INTO goods_size(goods_size_no, size_name, goods_no)
    ...
    INSERT INTO goods_size(goods_size_no, size_name, goods_no)
    VALUES (goods_size_seq.nextval, 'XXL', 1);
    commit; 

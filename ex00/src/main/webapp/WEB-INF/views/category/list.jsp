				...
				<ul class="nav nav-tabs">
					<c:forEach items="${listBig }" var="vo">
						<li class="nav-item"><a
							...
							data-cate_code1="${vo.cate_code1}"> <span class="cate_name">${vo.cate_name }</span>
					...
					<li class="nav-item"><a class="nav-link" data-toggle="tab"
						...
						id="writeBigBtn"><i class="fa fa-plus"></i></a></li>
				</ul>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<form action="" method="post" id="modalForm">
					<input type="hidden" name="cate_code1" id="modalCateCode1"
						value="0"> <input type="hidden" name="cate_code2"

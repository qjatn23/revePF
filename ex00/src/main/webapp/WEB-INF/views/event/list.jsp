...
<body class="body" id="body">
		...
		<main class="main" role="main">
			<div class="main-wrap">
				...
				<section class="section section-width__limit productpage-timedeal"
					...
					<div class="timedeal-wrap swiper">
					...
					<div class="gallery_list">
						<div>
							...
							<input type="hidden" name="sortBy" id="sortBy"
								value="${param.sortBy}" /> <input type="hidden"
								name="sortOrder" id="sortOrder" value="${param.sortOrder}" />

							<div class="sort-radio-buttons">
								<label><input type="submit" name="sort" value="default"
									${param.sortBy == null ? 'checked' : ''}
									onclick="setSort('default')" /> 신상품
								...
								<div>
									...
									<div class="gallery-text">
										...
										<div class="sale_price">
											<span class="discount">${vo.discount_rate}%</span> <span
												class="price"><fmt:formatNumber value="${vo.price}" />
												원 </span> <span class="sale"><fmt:formatNumber
													value="${vo.sale_price}" /> 원 </span>
										</div>
	...
	<script src="/resources/js/product.js?ver=1"></script>
	<script src="/resources/js/product_page.js?ver=1"></script>
	<script src="/resources/js/swipers.js?ver=1"></script>

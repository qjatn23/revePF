...
<body>
			...
			<form action="write.do" method="post" enctype="multipart/form-data">
				<div class="card-body">
					...
					<div class="form-group">
						<label for="brands_cate_code1">대분류</label> <select
							...
							<c:forEach items="${listBig }" var="vo">
								<option value="${vo.brands_cate_code1 }">${vo.brands_cate_name }</option>
							</c:forEach>
						</select>
					</div>
					<div class="form-group">
						<label for="brands_cate_code2">중분류</label> <select
							...
							<c:forEach items="${listMid }" var="vo">
								<option value="${vo.brands_cate_code2 }">${vo.brands_cate_name }</option>
							</c:forEach>
						</select>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<label for="imageMain">대표이미지</label> <input type="file"
					...
					<div class="form-group">
						<label for="discount_rate">할인율</label> <input class="form-control"
							id="discount_rate" name="discount_rate" value="0">
					</div>
					<div class="form-group">
						<label for="saved_rate">적립율</label> <input class="form-control"
							id="saved_rate" name="saved_rate" value="0">
					</div>
					<div class="form-group">
	...
	$(function() {
	    ...
	    // 생산일은 현재날짜 이전만 입력가능
	    $("#product_date").datepicker("option", {
		"maxDate" : new Date()
	    });
	    ...
	    $("#sale_start_date").change(
		    function() {
			$("#sale_end_date").datepicker("option", "minDate",
				$(this).val())
		    });
	    $("#sale_end_date").change(
		    function() {
			$("#sale_start_date").datepicker("option", "maxDate",
				$(this).val());
		    });
	    ...
	    $("#brands_cate_code1")
		    .change(
				...
				//alert("brands_cate_code1 = " + brands_cate_code1);

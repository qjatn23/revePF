...
<link rel="stylesheet" href="/resources/styles/product_detail.css?after">
<link rel="stylesheet" href="/resources/styles/view.css?ver=6.0">
</head>
<body>
		...
		<div class="card" style="border: none;">
			<div class="card-body">
				<div class="row">
					...
					<section
						class="section section-width__limit section-no__margin media-community">
						<div class="comm-inner">
							...
							<ul class="tabs">
								...
								<li class="tab" id="returnTab">Return & Delivery</li>
							</ul>

							<!-- Tab Content -->
							<form class="tab-content" id="formContent">
